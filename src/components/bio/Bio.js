  ...
  return (
    <div id={'Bio-Section'}>
      <div className={'bioContainer'}>
        <Photo image={loren} credit={'Vincente Santiago'} alt={'loren standing in wildflowers'}/>
        <div className={'bioText'}>
          Combining carefree melodies and fuzzy guitars, Humdrum is the latest
          music project of Chicago's Loren Vanderbilt III. After the dissolution of previous band Star Tropics, 
          ...
          Daydreaming to the jangle pop of IRS-era R.E.M., Felt, The Railway Children, New Order, and 90's staples like Ride and Slowdive, 
